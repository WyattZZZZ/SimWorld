...
| example_city/ | Sample city layout outputs from procedural generation. | Generated by `layout_generation.ipynb` in examples/. | Serves as reference outputs for city generation. |